...
- **Decision**: Adopted a Familyspace-based isolation model.
- **Rationale**: To ensure strict data integrity and privacy between different family archives, preventing cross-familyspace data leakage and ensuring that users only access the content within their assigned/created familyspaces.
