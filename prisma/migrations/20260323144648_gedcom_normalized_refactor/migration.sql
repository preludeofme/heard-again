/*
  ...
  - A unique constraint covering the columns `[familyspaceId,gedcomXref]` on the table `Person` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE INDEX "FamilyUnit_familyspaceId_idx" ON "FamilyUnit"("familyspaceId");
...
-- CreateIndex
CREATE UNIQUE INDEX "FamilyUnit_familyspaceId_gedcomXref_key" ON "FamilyUnit"("familyspaceId", "gedcomXref");
...
-- CreateIndex
CREATE UNIQUE INDEX "Person_familyspaceId_gedcomXref_key" ON "Person"("familyspaceId", "gedcomXref");
...
-- AddForeignKey
ALTER TABLE "FamilyUnit" ADD CONSTRAINT "FamilyUnit_familyspaceId_fkey" FOREIGN KEY ("familyspaceId") REFERENCES "Familyspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;
